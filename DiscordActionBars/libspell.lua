print("libspell begin")

-- load pfUI environment
--setfenv(1, pfUI:GetEnvironment())
DiscordActionBars = DiscordActionBars or {}
DiscordActionBars.api = DiscordActionBars.api or {}

-- return instantly when another libspell is already active
if DiscordActionBars.api.libspell then return end

local libtipscan = DiscordActionBars.api.libtipscan
...
DiscordActionBars.api.libspell = libspell

print("libspell loaded")
